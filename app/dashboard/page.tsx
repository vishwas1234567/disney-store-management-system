  ...
  return (
    <div className="container mx-auto p-6 md:p-8 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-8 flex flex-col justify-center transition-all duration-300 hover:shadow-xl hover:border-blue-200 hover:-translate-y-2 relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-4 opacity-[0.03] transform translate-x-4 -translate-y-2 group-hover:scale-110 group-hover:opacity-10 transition-all duration-300 text-blue-600">
            <Package size={140} strokeWidth={1.5} />
          </div>
          <p className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-3 relative z-10 flex items-center gap-2">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-8 flex flex-col justify-center transition-all duration-300 hover:shadow-xl hover:border-purple-200 hover:-translate-y-2 relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-4 opacity-[0.03] transform translate-x-4 -translate-y-2 group-hover:scale-110 group-hover:opacity-10 transition-all duration-300 text-purple-600">
            <ShoppingCart size={140} strokeWidth={1.5} />
          </div>
          <p className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-3 relative z-10 flex items-center gap-2">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-8 flex flex-col justify-center transition-all duration-300 hover:shadow-xl hover:border-green-200 hover:-translate-y-2 relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-4 opacity-[0.03] transform translate-x-4 -translate-y-2 group-hover:scale-110 group-hover:opacity-10 transition-all duration-300 text-green-600">
